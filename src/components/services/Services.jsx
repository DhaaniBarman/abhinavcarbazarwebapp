    ...
    return (
        <>
            <div className="container-fluid mt-5"> 
                    <h3 class=" text-uppercase text-center pb-5" id='servicehead'>Our Services</h3>
                    <div class="row">
                        <div class="col-lg-4 col-md-6 mb-2">
                            <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <h3 class="display-2 text-white mt-n2 m-0">01</h3>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-2">
                            <div class="service-item active d-flex flex-column justify-content-center px-4 mb-4">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <h3 class="display-2 text-white mt-n2 m-0">02</h3>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-2">
                            <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <h3 class="display-2 text-white mt-n2 m-0">03</h3>
                                </div>
